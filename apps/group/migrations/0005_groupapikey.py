...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('group', '0004_rename_wifi_group_wifi'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='api_keys', to='group.group')),
            ],
            options={
                'db_table': 'group_api_key',
            },
        ),
    ]
