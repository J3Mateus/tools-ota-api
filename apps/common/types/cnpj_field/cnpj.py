...
from .validators import cnpj_random_generator, is_valid_cnpj

def cnpj_to_python(value):
    if value in [None, '']:
        cnpj_number = value
    elif isinstance(value, str):
        cnpj_number = CNPJ.from_string(cnpj_number=value)
...
class CNPJ(object):
    ...
    @classmethod
    def from_string(cls, cnpj_number):
        cnpj_number_obj = cls(cnpj_number)
        return cnpj_number_obj
